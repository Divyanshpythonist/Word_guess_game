...
print("2) If the correct answer is Divyansh and you type divyansh or Divyansh or diVYansh it will be considered correct, i.e., case insensitive.")
...
while True:
  ...
  while True:
    if input_answer=="QUIT":
      ...
      print("Type your answer please : ")
      input_answer = input()
    elif input_answer.lower()==selected_word:
      print("\nCorrect Answer\n")
